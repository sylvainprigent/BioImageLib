/// \file blRandomGeneratorPM.cpp
/// \brief blRandomGeneratorPM class
/// \author Sylvain Prigent
/// \version 0.1
/// \date 2014

#include "blRandomGeneratorPM.h"
...
long blRandomGeneratorPM::m_seed;

float blRandomGeneratorPM::rand(){
...
void blRandomGeneratorPM::srand(long seed){
    m_seed = seed;
}
