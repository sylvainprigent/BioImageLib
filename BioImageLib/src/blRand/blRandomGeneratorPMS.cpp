/// \file blRandomGeneratorPMS.cpp
/// \brief blRandomGeneratorPMS class
/// \author Sylvain Prigent
/// \version 0.1
/// \date 2014

#include "blRandomGeneratorPMS.h"
...
long blRandomGeneratorPMS::m_seed;

float blRandomGeneratorPMS::rand(){
...
void blRandomGeneratorPMS::srand(long seed){
    m_seed = seed;
}
