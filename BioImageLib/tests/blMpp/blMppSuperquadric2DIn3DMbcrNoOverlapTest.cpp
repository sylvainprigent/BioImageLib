...
std::vector<blMppShape*> runMpp(std::string imageFile, std::string birthMap){
    ...
    // initialize classes
    blMppGeneratorShapeSuperquadric2DIn3D* generator = new blMppGeneratorShapeSuperquadric2DIn3D();
    generator->setMajorAxisRange(5, 8);
    generator->setMinorAxisRange(4, 7);
    generator->setThetaRange(0, 3.14, 0.2);
    generator->setMajorExposantRange(2, 4, 1);
    generator->setMinorExposantRange(2, 4, 1);
